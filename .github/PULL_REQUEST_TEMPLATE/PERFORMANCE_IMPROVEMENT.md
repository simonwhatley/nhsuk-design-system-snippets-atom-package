...
- The pull request must only fix an existing bug. To contribute other changes, you must use a different template. You can see all templates at https://github.com/simonwhatley/nhsuk-design-system-snippets-atom-package/tree/master/.github/PULL_REQUEST_TEMPLATE.
- After you create the pull request, all status checks must be pass before a maintainer reviews your contribution. For more details, please see https://github.com/simonwhatley/nhsuk-design-system-snippets-atom-package/tree/master/CONTRIBUTING.md#pull-requests.
